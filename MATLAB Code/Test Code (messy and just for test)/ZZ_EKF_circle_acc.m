...
param.initialEstimateError  = 1E5 * ones(1, 4);
param.motionNoise           = [1000, 1000, 150, 150];
param.measurementNoise      = [2500, 2500];
...
while ~isDone(vr)
    ...
    if ~isTrackInitialized
        if isObjectDetected
            ...
            x=[initialLocation(1);initialLocation(2);0.24;0.01];
